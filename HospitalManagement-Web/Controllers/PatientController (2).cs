...
namespace HospitalManagement_Web.Controllers
{
    public class PatientController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LastName,FirstMidName,Gender,SocialSecurityNumber,Address,ZipCode,City,PhoneNumber,RegistrationDate")] Patient patient)
        {
            if (ModelState.IsValid)
            {
